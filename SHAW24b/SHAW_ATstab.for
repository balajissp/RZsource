...
C       
          RV=RH
c         if (nc.eq.0 .and. nsp.eq.0) then             ! accounted for below  GNF 9/19/2018
c            VFLUX=(VAPAIR-VAPSFC)/RV*(1.0d0-pplastic) ! accounted for below  GNF 9/19/2018
c         else                                         ! accounted for below  GNF 9/19/2018
c            Vapor transfer directly to snow or canopy is not limited by plastic
             VFLUX=(VAPAIR-VAPSFC)/RV                  ! accounted for below  GNF 9/19/2018
c         end if                                       ! accounted for below  GNF 9/19/2018
c           vflux=-evapmx*rhol-srootxt*rhol/dt
        ENDIF                                          ! accounted for below  GNF 9/19/2018
C       

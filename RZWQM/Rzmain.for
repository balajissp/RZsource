...
C
     ...
     +    IRTYPE(MXSPEC),OMSEA(MXANA),NUTEQ(12),IRRTYP(MXAPP),
...
C
      INTEGER NDXN2H(MXNOD),NUTEQ(12)
C
      OPEN(IFILE,FILE='STATE.BIN',STATUS='OLD',FORM='UNFORMATTED',ERR=90
     +    )
C
...
C
      OPEN(IFILE,FILE='STATE.BIN',STATUS='UNKNOWN',FORM='UNFORMATTED',
     +    ERR=50)
C

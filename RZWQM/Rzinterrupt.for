...
C     CROPGRO() variables
     ...
     &    PCTMAT
      ...
      REAL PODWTD, PG, PCLSD, PCCSD, PCNSH
...
C       WRITE(IFILE,*) alaireset, WSI,heightset
     ...
     +  TMPLNT,TXPLNT,IJ)
      ...
      WRITE(IFILE,*) '==============DSSATDRV_Memory=================='
      CALL DSSATDRV_Memory('GET', oldhgt,PLHGHT,PLALFA,ISTAGE)
      WRITE(IFILE, *) oldhgt,PLHGHT,PLALFA,ISTAGE
...
C       CALL GETPUT_PLantStres('GET', Plantstres)
C       WRITE(IFILE,*) Plantstres%NSTAGES, Plantstres%StageName,
C      +  Plantstres%TURFAC, Plantstres%SWFAC, Plantstres%NSTRES, 
C      +  Plantstres%AGEFAC, Plantstres%ACTIVE
     ...
     &  KEP, RWUEP1)
      WRITE(IFILE,'(A1,A6,I,I,I)') DETACH, ECONO, NDLEAF, NDSET, NOUTDO
      WRITE(IFILE,*) NR1, NR2, NR5, NR7, YREMRG, YRNR1, YRNR2,
     &  YRNR3, YRNR5, YRNR7, AGEFAC, AGRSD3, AREALF, ASMDOT, AGRLF, 
     &  AGRRT, AGRSH2, AGRSTM, AGRSD1, AGRSD2, AGRVG, AGRVG2, AGRNOD, 
     &  AGRSH1, BETN, CANNAA, CANWAA, CDMREP, CGRSH, CGRSD, CNODMN, 
     &  CO2, CSAVEV, CNDFX, CTONODR, CTONOD, CAVVEG, CADPR1, CMOBMX, 
     ...
     &  KEP, RWUEP1
      ...
      WRITE(IFILE, *)  ASAVE,TFIRST,DELTSV
     ...
     +    SNP, SSTART, PKTEMP, hrootdummy, IDIMIYOLD, wthour, totalsub)
      WRITE(IFILE,*) PERIOD, SPAN, DELT, START, NBPR, 
     +    COR, TTRO, STMSEG, ND, FIRST5, JSTDAY,
     +    TSTART, OLDSTR, TRFDD, TCII, TROI, NBPRI, CANIRR, HROOT, RNDR, 
     +    SNP, SSTART, PKTEMP, hrootdummy, IDIMIYOLD, wthour, totalsub
C
...
C       PRINT *, "OPWBAL success"
     ...
     +  TMPLNT,TXPLNT,IJ)
      ...
      READ(IFILE, *) STRING
      PRINT *, STRING
      READ(IFILE, *) oldhgt,PLHGHT,PLALFA,ISTAGE
...
C       READ(IFILE,*) Plantstres%NSTAGES, Plantstres%StageName,
C      +  Plantstres%TURFAC, Plantstres%SWFAC, Plantstres%NSTRES, 
C      +  Plantstres%AGEFAC, Plantstres%ACTIVE
C       CALL GETPUT_PLantStres('PUT', Plantstres)

      READ(IFILE,'(A1,A6,I,I,I)') DETACH, ECONO, NDLEAF, NDSET, NOUTDO 
      READ(IFILE,*) NR1, NR2, NR5, NR7, YREMRG, YRNR1, YRNR2,
     &  YRNR3, YRNR5, YRNR7, AGEFAC, AGRSD3, AREALF, ASMDOT, AGRLF, 
     &  AGRRT, AGRSH2, AGRSTM, AGRSD1, AGRSD2, AGRVG, AGRVG2, AGRNOD, 
     &  AGRSH1, BETN, CANNAA, CANWAA, CDMREP, CGRSH, CGRSD, CNODMN, 
     &  CO2, CSAVEV, CNDFX, CTONODR, CTONOD, CAVVEG, CADPR1, CMOBMX, 
     ...
     &  KEP, RWUEP1)
      ...
      READ(IFILE, *)  ASAVE,TFIRST,DELTSV
      CALL ADJDT_Memory('PUT',ASAVE,TFIRST,DELTSV)

      READ(IFILE,*) PERIOD, SPAN, DELT, START, NBPR, 
     +    COR, TTRO, STMSEG, ND, FIRST5, JSTDAY,
     +    TSTART, OLDSTR, TRFDD, TCII, TROI, NBPRI, CANIRR, HROOT, RNDR, 
     +    SNP, SSTART, PKTEMP, hrootdummy, IDIMIYOLD, wthour, totalsub

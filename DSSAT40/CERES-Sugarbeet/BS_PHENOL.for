...
C  PHENOL, Subroutine
C
C  Determines Phenological Stage and Growing Degree Days for sugarbeet
C----------------------------------------------------------------------
C  Revision history
C
C               Written
...
C----------------------------------------------------------------------
      SUBROUTINE BS_PHENOL(DYNAMIC,ISWWAT,FILEIO,NOUTDO,IDETO,    !C
...
C             3 - End leaf growth
C             4 - Beginning effective growth
C             5 - Effective Growth
C             6 - Maturity
C     ----------------------------------------------------------
  ...
  100         CONTINUE                                ! Sun Fix
     ...
     &                    (SW(L0+1)-LL(L0+1))*0.35
      ...
      !-----------------------------------------------------------------
      !       ISTAGE = 2 - End of Juvenile Stage to Pennicle Initiation
      !-----------------------------------------------------------------
      ...
      !-----------------------------------------------------------------
      !       ISTAGE = 3 - Pennicle Initiation to End of Leaf Growth
      !-----------------------------------------------------------------
      ...
      !-----------------------------------------------------------------
      !       ISTAGE = 4 - End of Leaf Growth to Beginning Effective Gro
      !-----------------------------------------------------------------
      ...
      !-----------------------------------------------------------------
      !       ISTAGE = 5 - Beginning to end of effective growth phase
      !-----------------------------------------------------------------

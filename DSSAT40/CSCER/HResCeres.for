...
C=======================================================================
      ...
      SUBROUTINE HRes_Ceres(CONTROL,SOILPROP,
...
!       Total root residues (whole profile) equal root weight 
        TRTRES = RTWT * PLTPOP * 10. *(1. - HARVFRAC(3))         !kg/ha added to harvest above/below ground
!             g/plant * plants/m2

!       N in root residues.
        TRTRESE(N) = ROOTN * PLTPOP * 10. *(1. - HARVFRAC(3))    !kg/ha  added to harvest above/below ground
!                 g[N]/plant * plants/m2  

C=======================================================================
C  ML_OPHARV, Subroutine C.H. Porter
...
!     08/11/2005 CHP changed from BWAH to BWAM, 
      ...
      WRITE(Simulated(22),'(F8.2)') RNAD;WRITE(Measured(22),'(A8)')X(22)  !RNAD
      WRITE(Simulated(23),'(F8.2)') RWAD;WRITE(Measured(23),'(A8)')X(23)  !RWAD

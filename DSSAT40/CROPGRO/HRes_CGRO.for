...
C=======================================================================
      ...
      SUBROUTINE HRes_CGRO(CONTROL,SOILPROP,
...
!   Liwang Ma, 9-17-2007, to compute residue at all times. 
...
!       weight.
        TRTRES = (RTWT + DWNOD)* (1. - HARVFRAC(3))  !added to harvest above/below ground

!       N in root residues is N in roots plus N in nodules.
        TRTRESE(N) = (WTNRT + WTNNOD) *(1. - HARVFRAC(3))  !added to harvest above/below ground
...
!       to add it here as WTRO and WTNOO, as in the CERES-based module.
     ...
     &                            * RLV(L)*DLAYR(L) / TRLV
            HResE(L,N) = 10. * TRTRESE(N) * RLV(L)*DLAYR(L) / TRLV

...
C-----------------------------------------------------------------------
  ...
  200     FORMAT('@YEAR DOY   DAS    SOCD   OMAC',
     ...
     &      '    HUM6   HUM7   HUM8   HUM9 HUM10',
     &      ' HUM11 HUM12 HUM13 HUM14 HUM15  TFON',
     &      '  NHU1  NHU2  NHU3  NHU4  NHU5',  
     &      '  NHU6  NHU7  NHU8  NHU9 NHU10',
     &      ' NHU11 NHU12 NHU13 NHU14 NHU15  SNDD  SCDD')
        ENDIF
      ENDIF
...
C-----------------------------------------------------------------------
  ...
  310     FORMAT(1X,I4,1X,I3.3,3(1X,I5),1X,F7.1,1X,F6.1,I8,2F7.1,
     ...
     &        NINT(CUMRES), NINT(TFOM), (NINT(HUMC(I)),I=1,15), 
     &        NINT(TFON), (NINT(HUMN(I)),I=1,15), NINT(SNDD), NINT(SCDD)
  400     FORMAT(1X,I4,1X,I3.3,1X,I5,I8,11(1X,I6),33(1X,I5))
        ENDIF
      ENDIF

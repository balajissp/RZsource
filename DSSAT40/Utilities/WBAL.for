...
c     &    DRAIN, ES, FLOODWAT, IRRAMT, RAIN, RUNOFF, SNOW,
c     &    SWDELTS, SWDELTU, SWDELTX, DLAYR, NLAYR,
     &    DRAIN, ES, IRRAMT, RAIN, RUNOFF, SNOW,
     &    DLAYR, NLAYR,
...
!     ------------------------------------------------------------------
      ...
      INTEGER RUN, YEAR, YRSIM, YRDOY, NBUND,yrplt
...
C-----------------------------------------------------------------------
  ...
  320 FORMAT(/,5X,'WATER BALANCE PARAMETERS',
     ...
     &                   CES, CEP, CEO
  400 FORMAT(
     &       /,5X,'Soil H2O (start) on Year/day',I5,'/',I3.3,T44,F10.2,
     &       /,5X,'Soil H2O (final) on Year/day',I5,'/',I3.3,T44,F10.2,

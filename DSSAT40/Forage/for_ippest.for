...
C-----------------------------------------------------------------------
c      READ(LUNIO,'(/////,15X,A12,////,15X,A12,1X,A80)') 
c     &    FILET, FILEP, PATHPE
...
c      SECTION = '*CULTI'
c      CALL FIND(LUNIO, SECTION,LNUM,FOUND)
c      IF (FOUND .EQ. 0) CALL ERROR (ERRKEY,4,FILEIO,LNUM)
c      READ(LUNIO,140) CROP
140   FORMAT(3X,A2)
